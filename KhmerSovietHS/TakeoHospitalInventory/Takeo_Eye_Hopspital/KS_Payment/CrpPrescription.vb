...
Public Class CrpPrescription
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.CrpPrescription.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpPrescription
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpPrescription = New CrpPrescription
        rpt.Site = Me.Site
        Return rpt
    End Function
