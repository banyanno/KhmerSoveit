...
Public Class IssureInvoiceBK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.IssureInvoiceBK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIssureInvoiceBK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IssureInvoiceBK = New IssureInvoiceBK
        rpt.Site = Me.Site
        Return rpt
    End Function
