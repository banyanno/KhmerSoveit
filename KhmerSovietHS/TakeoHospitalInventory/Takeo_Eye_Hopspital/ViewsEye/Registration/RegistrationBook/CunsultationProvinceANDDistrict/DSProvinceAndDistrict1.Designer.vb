...
Partial Public Class DSProvinceAndDistrict
    ...
    Partial Public Class V_DiagnosisByDistrictDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddV_DiagnosisByDistrictRow(ByVal Male As Integer, ByVal Female As Integer, ByVal Months As Integer, ByVal YEARS As Integer, ByVal Diagnosis As String, ByVal Province As String) As V_DiagnosisByDistrictRow
            Dim rowV_DiagnosisByDistrictRow As V_DiagnosisByDistrictRow = CType(Me.NewRow,V_DiagnosisByDistrictRow)
            Dim columnValuesArray() As Object = New Object() {Male, Female, Months, YEARS, Diagnosis, Province}
    ...
    Partial Public Class V_DiagnosisByDistrictRow
        ...
        Public Property Province() As String
            Get
                Try 
                    Return CType(Me(Me.tableV_DiagnosisByDistrict.ProvinceColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Province' in table 'V_DiagnosisByDistrict' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableV_DiagnosisByDistrict.ProvinceColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsProvinceNull() As Boolean
            Return Me.IsNull(Me.tableV_DiagnosisByDistrict.ProvinceColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetProvinceNull()
            Me(Me.tableV_DiagnosisByDistrict.ProvinceColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace DSProvinceAndDistrictTableAdapters
    ...
    Partial Public Class V_DiagnosisByDistrictTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        Province, Male, Female, Months, YEARS, Diagnosis"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            V"& _ 
                "_DiagnosisByDistrict"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Months = @Month) AND (YEARS = @Year) AND (Pr"& _ 
                "ovince = @District) OR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         (Months IS NULL) AND (YEARS IS "& _ 
                "NULL)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@District", Global.System.Data.SqlDbType.NVarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "Province", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As DSProvinceAndDistrict.V_DiagnosisByDistrictDataTable, ByVal Month As Global.System.Nullable(Of Integer), ByVal Year As Global.System.Nullable(Of Integer), ByVal District As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Month.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(Month.Value,Integer)
            Else
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(2).Value = CType(District,String)
            End If
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData(ByVal Month As Global.System.Nullable(Of Integer), ByVal Year As Global.System.Nullable(Of Integer), ByVal District As String) As DSProvinceAndDistrict.V_DiagnosisByDistrictDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Month.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(Month.Value,Integer)
            Else
