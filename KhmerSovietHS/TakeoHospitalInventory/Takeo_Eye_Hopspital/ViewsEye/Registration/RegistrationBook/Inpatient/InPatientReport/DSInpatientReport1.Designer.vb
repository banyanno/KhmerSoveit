...
Partial Public Class DSInpatientReport
    ...
    Partial Public Class V_InpatientDetailDataTable
        ...
        Public Overloads Function AddV_InpatientDetailRow( _
                    ...
                    ByVal CalDolarFull As Double) As V_InpatientDetailRow
            Dim rowV_InpatientDetailRow As V_InpatientDetailRow = CType(Me.NewRow,V_InpatientDetailRow)
            Dim columnValuesArray() As Object = New Object() {InNo, PatientNo, ReceiptNo, NameKhmer, Age, Sex, Address, Diagnosis, TypeOfOperation, HosFee, SosialFee, DolarSosial, FullFee, DolarFull, Other, CreateDate, DeleteOption, CalDolarSosial, CalDolarFull}
...
Namespace DSInpatientReportTableAdapters
    ...
    Partial Public Class V_InpatientDetailTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT InNo, PatientNo, ReceiptNo, NameKhmer, Age, Sex, Address, Diagnosis, TypeO"& _ 
                "fOperation, HosFee, SosialFee, DolarSosial, FullFee, DolarFull, Other, CreateDat"& _ 
                "e, DeleteOption, CalDolarSosial, CalDolarFull FROM dbo.V_InpatientDetail"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
