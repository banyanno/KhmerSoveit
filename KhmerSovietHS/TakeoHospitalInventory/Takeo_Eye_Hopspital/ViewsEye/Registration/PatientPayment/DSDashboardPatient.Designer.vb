...
Partial Public Class DSDashboardPatient
    ...
    Partial Public Class TblPatientsDataTable
        ...
        Public Overloads Function AddTblPatientsRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {Nothing, PatientNo, CreateDate, Province, District, Commune, NameEng, NameKhmer, Age, Male, Female, Sex, Address, Occupation, Telephone, Neighborly, OlePatientNo, PatientPicture}
    ...
    Partial Public Class TblPatientsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [TblPatients] ([PatientNo], [CreateDate], [Province], [District], [Co"& _ 
                ...
                "hone, Neighborly, OlePatientNo, PatientPicture FROM TblPatients WHERE (PatientNo"& _ 
                " = @PatientNo)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [TblPatients] SET [PatientNo] = @PatientNo, [CreateDate] = @CreateDate, [P"& _ 
                ...
                "ress, Occupation, Telephone, Neighborly, OlePatientNo, PatientPicture FROM TblPa"& _ 
                "tients WHERE (PatientNo = @PatientNo)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        Address, Age, Commune, CreateDate, District, Female, Male, NameEng,"& _ 
                ...
                "s"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (PatientNo IS NOT NULL) AND (CAST(CONVERT(VARCHAR(10), CreateDat"& _ 
                "e, 1) AS DateTime) BETWEEN CAST(CONVERT(VARCHAR(10), CAST(@DFrom AS DATETIME), "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         1) AS Datetime) AND CAST(CONVERT(VARCHAR(10), CAST(@DT"& _ 
            ...
            Me._commandCollection(2).CommandText = "SELECT        No, PatientNo, CreateDate, Province, District, Commune, NameEng, Na"& _ 
                "meKhmer, Age, Male, Female, Sex, Address, Occupation, Telephone, Neighborly, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" "& _ 
                "                        OlePatientNo, PatientPicture"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            TblPatient"& _ 
