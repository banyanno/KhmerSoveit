...
Partial Public Class DSWardWithOT
    ...
    Partial Public Class View_OTRegistrationDataTable
        ...
        Public Overloads Function AddView_OTRegistrationRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {OTNo, Nothing, PatientNo, Age, Sex, Address, OperationTime, Anesthesia, Eye, OperationType, Surgeon, Assistant, Circulation, Compli, CreateDate, Status, NameKhmer, Anesthetist, IOL, DateOperated, Others, NameEng}
    ...
    Partial Public Class V_NewInpatientDetialLeaveDataTable
        ...
        Public Overloads Function AddV_NewInpatientDetialLeaveRow( _
                    ...
                    ByVal TypeDiagnosis As Boolean) As V_NewInpatientDetialLeaveRow
            Dim rowV_NewInpatientDetialLeaveRow As V_NewInpatientDetialLeaveRow = CType(Me.NewRow,V_NewInpatientDetialLeaveRow)
            Dim columnValuesArray() As Object = New Object() {NewInPatientNo, PatientNo, NameKhmer, Age, Sex, Address, Eye, Diagnosis, VA_RE, VA_LE, DateDischarge, DateFollowUp, Signature, Leave, CreateDate, Waiting, TypeDiagnosis}
...
Namespace DSWardWithOTTableAdapters
    ...
    Partial Public Class View_OTRegistrationTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        OTNo, NewInPatientNo, PatientNo, NameKhmer, Age, Sex, Address, Oper"& _ 
                ...
                "d, Others, NameEng"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            View_OTRegistration"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class V_NewInpatientDetialLeaveTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     NewInPatientNo, PatientNo, NameKhmer, Age, Sex, Address, Eye, Diagnosi"& _ 
                "s, VA_RE, VA_LE, DateDischarge, DateFollowUp, Signature, Leave, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"              "& _ 
                "        CreateDate, Waiting, TypeDiagnosis"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         V_NewInpatientDetialLea"& _ 
                "ve"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
