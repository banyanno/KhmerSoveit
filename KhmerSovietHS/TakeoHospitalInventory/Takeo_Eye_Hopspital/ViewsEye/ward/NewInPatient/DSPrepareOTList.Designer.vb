...
Partial Public Class DSPrepareOTList
    ...
    Partial Public Class V_NewInpatientDetialDataTable
        ...
        Public Overloads Function AddV_NewInpatientDetialRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {NewInPatientNo, PatientNo, NameKhmer, Age, Sex, Address, Eye, Diagnosis, VA_RE, VA_LE, DateDischarge, DateFollowUp, Signature, Leave, CreateDate, TypeDiagnosis, Waiting}
