...
Public Class DialyFollowup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.DialyFollowup.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DateFollowup() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDialyFollowup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DialyFollowup = New DialyFollowup
        rpt.Site = Me.Site
        Return rpt
    End Function
