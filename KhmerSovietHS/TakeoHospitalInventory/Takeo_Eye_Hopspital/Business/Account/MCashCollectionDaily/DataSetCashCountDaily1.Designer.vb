...
Partial Public Class DataSetCashCountDaily
    ...
    Partial Public Class tblPatientReceiptDataTable
        ...
        Public Overloads Function AddtblPatientReceiptRow( _
                    ...
                    ByVal MedicineFeeUSD As Double) As tblPatientReceiptRow
            Dim rowtblPatientReceiptRow As tblPatientReceiptRow = CType(Me.NewRow,tblPatientReceiptRow)
            Dim columnValuesArray() As Object = New Object() {DateIn, CashUSD, CashRiel, OutPatientUSD, OutPatientRiel, InPatientUSD, InPatientRiel, GlassFeeUSD, GlassFeeRiel, ArtificialEyeFeeUSD, ArtificialEyeFeeRiel, OtherFeeUSD, OtherFeeRiel, HN, Nothing, IDCashReceipt, ReceiptNo, HN1, MedicineFeeRiel, MedicineFeeUSD}
...
Namespace DataSetCashCountDailyTableAdapters
    ...
    Partial Public Class tblPatientReceiptTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     CONVERT(VARCHAR(11), DateIn, 106) AS DateIn, CashUSD, CashRiel, Consul"& _ 
                "tationFeeUSD + FollowUpFeeUSD AS OutPatientUSD, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      Consulta"& _ 
                "tionFeeRiel + FollowUpFeeRiel AS OutPatientRiel, OperationFeeUSD  AS InPatientUS"& _ 
                "D, OperationFeeRiel AS InPatientRiel, GlassFeeUSD, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      Glass"& _ 
                "FeeRiel, ArtificialEyeFeeUSD, ArtificialEyeFeeRiel, OtherFeeUSD, OtherFeeRiel, H"& _ 
                "N, ID, IDCashReceipt, ReceiptNo, MedicineFeeRiel, MedicineFeeUSD"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         t"& _ 
                "blPatientReceipt"
