...
Partial Public Class DSUserManagement
    ...
    Partial Public Class VGroupPermistionDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddVGroupPermistionRow(ByVal MenuDisplay As String, ByVal MenuNo As String, ByVal GroupNo As Integer, ByVal GroupID As Integer) As VGroupPermistionRow
            Dim rowVGroupPermistionRow As VGroupPermistionRow = CType(Me.NewRow,VGroupPermistionRow)
            Dim columnValuesArray() As Object = New Object() {MenuDisplay, MenuNo, GroupNo, GroupID}
...
Namespace DSUserManagementTableAdapters
    ...
    Partial Public Class VGroupPermistionTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT MenuDisplay, MenuNo, GroupNo, GroupID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM VGroupPermistion"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT GroupID, GroupNo, MenuDisplay, MenuNo FROM VGroupPermistion WHERE (GroupNo"& _ 
                " = @GroupNo)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
